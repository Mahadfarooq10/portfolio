<template>
  ...
  >
    ...
    >
      <path
        d="M 75.412 83.663 h -4.451 v -4 h 4.451 c 0.437 0 0.791 -0.354 0.791 -0.791 V 4.791 C 76.203 4.355 75.849 4 75.412 4 H 21.83 c -0.436 0 -0.791 0.355 -0.791 0.791 v 3.546 h -4 V 4.791 C 17.039 2.149 19.188 0 21.83 0 h 53.582 c 2.642 0 4.791 2.149 4.791 4.791 v 74.081 C 80.203 81.514 78.054 83.663 75.412 83.663 z"
        style="
          stroke: none;
          stroke-width: 1;
          stroke-dasharray: none;
      ...
      />
      <path
        d="M 26.019 21.56 c -0.957 0 -1.735 0.778 -1.735 1.735 v 2.197 c 0 0.957 0.778 1.735 1.735 1.735 s 1.735 -0.778 1.735 -1.735 v -2.197 C 27.754 22.338 26.976 21.56 26.019 21.56 z"
        style="
          stroke: none;
          stroke-width: 1;
          stroke-dasharray: none;
      ...
      />
      <path
        d="M 56.723 22.032 c 0 0.299 0.243 0.543 0.543 0.543 h 14.482 c -0.067 -0.075 -0.119 -0.16 -0.19 -0.231 L 56.954 7.74 c -0.072 -0.072 -0.156 -0.124 -0.231 -0.19 V 22.032 z"
        style="
          stroke: none;
          stroke-width: 1;
          stroke-dasharray: none;
